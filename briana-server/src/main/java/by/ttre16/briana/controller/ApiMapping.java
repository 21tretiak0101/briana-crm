...
public class ApiMapping {
    ...
    public static final String EMPLOYEE_REST_URL = API + VERSION + "/employee";
    ...
    public static final String CATEGORY_REST_URL = API + VERSION + "/category";

    public static final String ORDER_REST_URL = API + VERSION + "/order";
